...
//     std::shared_ptr<ObstacleDetector<pcl::PointXYZ>> obstacle_detector;//oldType:ObDtc NewType PointXYZ
...
//     ros::subscribe sub_yolo_msg; //new line
...
//     void yoloMsgCallback(const sensor_msgs::PointCloud2::ConstPtr &lidar_points);//new line
...
//     private_nh.getParam("bounding_boxes_topic", bounding_boxes_topic);
//     private_nh.getParam("found_object_topic", found_object_topic);
...
//     // subscribe topics and use approximate syncronize
//     message_filters::Subscriber<sensor_msgs::PointCloud2::ConstPtr> sub_lidar_points(nh, lidar_points_topic, 1);
//     message_filters::Subscriber<Bobstacle_detector::BoundingBoxes::ConstPtr> sub_bounding_boxes(nh, bounding_boxes_topic, 1);
//     message_filters::Subscriber<String::ObjClasses::ConstPtr> sub_found_object(nh, found_object_topic, 1);
//     typedef sync_policies::ApproximateTime<Image, Image> SyncPolicy;
//     std::int sync_approxi_time = 5;
//     Synchronizer<SyncPolicy> sync(SyncPolicy(sync_approxi_time), sub_lidar_points, sub_bounding_boxes, sub_found_object);
//     sync.registerCallback(boost::bind(&objectCallback, _1, _2, _3));

//     // sub_lidar_points = nh.subscribe(lidar_points_topic, 1, &ObstacleDetectorNode::lidarPointsCallback, this);
//     // sub_lidar_points = nh.Subscriber(yolo_msg_topic, 1, &ObstacleDetectorNode::yoloMsgCallback, this);
...
//     obstacle_id_ = 0;
//   }
//   void ObstacleDetectorNode::objectCallback(const sensor_msgs::PointCloud2::ConstPtr &lidar_points, const obstacle_detector::BoundingBoxes::ConstPtr &bounding_boxes, const String::ObjClasses::ConstPtr &obj_classes)
//   {
...
//     pcl::PointCloud<pcl::PointXZY>::Ptr cloud_filtered (new pcl::PointCoud::PointXYZ);
//     //select FOV
//     pcl::PassThrough<pcl::PointXYZ> pass;
//     pass.setInputCloud(*raw_cloud);
//     pass.setFilterFieldName("x");
//     pass.setFilterLImits(1.0, 20.0);
...
//     // transofrom to world frame
//     tf2_ros::Buffer TF_BUFFER;
//     tf2_ros::TransormListener TF_LISTENER(TF_BUFFER);
//     pcl_ros::transformPointCloud('world',*cloud_filtered, *cloud_filtered, TF_LISTENER)
    
//     // project 2 picture coord
//     camera_matrix = {}
//     pcl::transformPointCLoud(*cloud_filtered, *cloud_filtered, camera_matrix)
