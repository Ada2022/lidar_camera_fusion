...
"""autogenerated by genpy from lidar_camera_calibration/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
class BoundingBoxes(genpy.Message):
  ...
  _type = "lidar_camera_calibration/BoundingBoxes"
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','lidar_camera_calibration/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = lidar_camera_calibration.msg.BoundingBox()
        _x = val1
        start = end
        end += 42
