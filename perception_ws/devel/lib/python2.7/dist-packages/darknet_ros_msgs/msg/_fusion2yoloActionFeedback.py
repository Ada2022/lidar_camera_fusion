...
"""autogenerated by genpy from darknet_ros_msgs/fusion2yoloActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class fusion2yoloActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "darknet_ros_msgs/fusion2yoloActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','darknet_ros_msgs/fusion2yoloFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(fusion2yoloActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = darknet_ros_msgs.msg.fusion2yoloFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = darknet_ros_msgs.msg.fusion2yoloFeedback()
