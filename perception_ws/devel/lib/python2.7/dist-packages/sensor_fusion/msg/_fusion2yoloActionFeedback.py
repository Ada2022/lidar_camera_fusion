...
"""autogenerated by genpy from sensor_fusion/fusion2yoloActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class fusion2yoloActionFeedback(genpy.Message):
  ...
  _type = "sensor_fusion/fusion2yoloActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sensor_fusion/fusion2yoloFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = sensor_fusion.msg.fusion2yoloFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = sensor_fusion.msg.fusion2yoloFeedback()
