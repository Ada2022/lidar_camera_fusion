...
"""autogenerated by genpy from sensor_fusion/fusion2yoloResult.msg. Do not edit."""
import codecs
import sys
...
class fusion2yoloResult(genpy.Message):
  _md5sum = "f28a5afc6bea5150fc58096d7a9b6801"
  _type = "sensor_fusion/fusion2yoloResult"
...
"""
  ...
  _slot_types = ['int16','sensor_fusion/BoundingBoxes']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(fusion2yoloResult, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.id is None:
        self.id = 0
      if self.bounding_boxes is None:
        self.bounding_boxes = sensor_fusion.msg.BoundingBoxes()
    else:
      self.id = 0
      self.bounding_boxes = sensor_fusion.msg.BoundingBoxes()
