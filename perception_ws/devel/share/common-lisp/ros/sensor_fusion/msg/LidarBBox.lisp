...
(cl:defmethod point_min-val ((m <LidarBBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:point_min-val is deprecated.  Use sensor_fusion-msg:point_min instead.")
  (point_min m))

(cl:ensure-generic-function 'point_max-val :lambda-list '(m))
(cl:defmethod point_max-val ((m <LidarBBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:point_max-val is deprecated.  Use sensor_fusion-msg:point_max instead.")
  (point_max m))
