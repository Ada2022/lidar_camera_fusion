...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_fusion-msg:<BoundingBox> is deprecated: use sensor_fusion-msg:BoundingBox instead.")))

(cl:ensure-generic-function 'probability-val :lambda-list '(m))
(cl:defmethod probability-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:probability-val is deprecated.  Use sensor_fusion-msg:probability instead.")
  (probability m))
...
(cl:defmethod id-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:id-val is deprecated.  Use sensor_fusion-msg:id instead.")
  (id m))
