...
(cl:defclass <ObstacleRanges> (roslisp-msg-protocol:ros-message)
  ((obstacle_ranges
    ...
    :type (cl:vector lidar_obstacle_detector-msg:ObstacleRange)
   :initform (cl:make-array 0 :element-type 'lidar_obstacle_detector-msg:ObstacleRange :initial-element (cl:make-instance 'lidar_obstacle_detector-msg:ObstacleRange))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObstacleRanges>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObstacleRanges)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_obstacle_detector-msg:<ObstacleRanges> is deprecated: use lidar_obstacle_detector-msg:ObstacleRanges instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObstacleRanges>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obstacle_ranges)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'lidar_obstacle_detector-msg:ObstacleRange))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObstacleRanges>)))
  ...
  "lidar_obstacle_detector/ObstacleRanges")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObstacleRanges)))
  "Returns string type for a message object of type 'ObstacleRanges"
  "lidar_obstacle_detector/ObstacleRanges")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObstacleRanges>)))
  ...
  (cl:format cl:nil "ObstacleRange[] obstacle_ranges~%~%================================================================================~%MSG: lidar_obstacle_detector/ObstacleRange~%string Class~%float64 xmin~%float64 ymin~%float64 zmin~%float64 xmax~%float64 ymax~%float64 zmax~%geometry_msgs/Point[] points~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObstacleRanges)))
  "Returns full string definition for message of type 'ObstacleRanges"
  (cl:format cl:nil "ObstacleRange[] obstacle_ranges~%~%================================================================================~%MSG: lidar_obstacle_detector/ObstacleRange~%string Class~%float64 xmin~%float64 ymin~%float64 zmin~%float64 xmax~%float64 ymax~%float64 zmax~%geometry_msgs/Point[] points~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
