...
(cl:defmethod position-val ((m <LidarBBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_obstacle_detector-msg:position-val is deprecated.  Use lidar_obstacle_detector-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'dimension-val :lambda-list '(m))
(cl:defmethod dimension-val ((m <LidarBBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_obstacle_detector-msg:dimension-val is deprecated.  Use lidar_obstacle_detector-msg:dimension instead.")
  (dimension m))
