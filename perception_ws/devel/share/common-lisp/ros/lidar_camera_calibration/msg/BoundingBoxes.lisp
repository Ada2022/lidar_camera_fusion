...
(cl:defclass <BoundingBoxes> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bounding_boxes
    ...
    :type (cl:vector lidar_camera_calibration-msg:BoundingBox)
   :initform (cl:make-array 0 :element-type 'lidar_camera_calibration-msg:BoundingBox :initial-element (cl:make-instance 'lidar_camera_calibration-msg:BoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_camera_calibration-msg:<BoundingBoxes> is deprecated: use lidar_camera_calibration-msg:BoundingBoxes instead.")))
...
(cl:defmethod image_header-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_camera_calibration-msg:image_header-val is deprecated.  Use lidar_camera_calibration-msg:image_header instead.")
  (image_header m))

(cl:ensure-generic-function 'bounding_boxes-val :lambda-list '(m))
(cl:defmethod bounding_boxes-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_camera_calibration-msg:bounding_boxes-val is deprecated.  Use lidar_camera_calibration-msg:bounding_boxes instead.")
  (bounding_boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bounding_boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'lidar_camera_calibration-msg:BoundingBox))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BoundingBoxes>)))
  ...
  "lidar_camera_calibration/BoundingBoxes")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BoundingBoxes)))
  "Returns string type for a message object of type 'BoundingBoxes"
  "lidar_camera_calibration/BoundingBoxes")
