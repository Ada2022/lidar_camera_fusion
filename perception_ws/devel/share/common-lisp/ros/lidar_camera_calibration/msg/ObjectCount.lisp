...
(cl:defmethod cl:initialize-instance :after ((m <ObjectCount>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectCount)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_camera_calibration-msg:<ObjectCount> is deprecated: use lidar_camera_calibration-msg:ObjectCount instead.")))
...
(cl:defmethod count-val ((m <ObjectCount>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_camera_calibration-msg:count-val is deprecated.  Use lidar_camera_calibration-msg:count instead.")
  (count m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObjectCount>)))
  ...
  "lidar_camera_calibration/ObjectCount")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObjectCount)))
  "Returns string type for a message object of type 'ObjectCount"
  "lidar_camera_calibration/ObjectCount")
